              ...
              <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                <li class="nav-item" role="presentation">
                  <button class="nav-link fs-15 p-3 active" id="pills-bio-diri-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-bio-diri" type="button" role="tab" aria-controls="pills-bio-diri"
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link fs-15 p-3" id="pills-bio-orangtua-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-bio-orangtua" type="button" role="tab" aria-controls="pills-bio-orangtua"
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link fs-15 p-3" id="pills-atribut-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-atribut" type="button" role="tab" aria-controls="pills-atribut"
                    aria-selected="false"><i
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="email" class="form-control" placeholder="example@gamil.com" id="email"
                        value={{ $pendaftar->user->email }} disabled>
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Nama" id="nama"
                        value="{{ $pendaftar->nama }}" name="nama">

                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      <label for="nisn" class="form-label">NISN</label>
                      <input type="text" class="form-control" placeholder="Masukkan NISN" id="nisn"
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Alamat" id="alamat"
                        value="{{ $pendaftar->alamat }}" name="alamat">

                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      <label for="jenis_tinggal" class="form-label">Jenis Tempat Tinggal</label>
                      <select id="jenis_tinggal" class="form-select" data-choices data-choices-sorting="true"
                        name="jenis_tinggal">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select id="kendaraan" class="form-select" data-choices data-choices-sorting="true"
                        name="kendaraan">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select id="kewarganegaraan" class="form-select" data-choices data-choices-sorting="true"
                        name="kewarganegaraan">
                        <option selected>Pilih Kewarganeragaan...</option>
                        <option value="wni" {{ $pendaftar->kewarganegaraan == 'wni' ? 'selected' : '' }}>Warga Negara
                          Indonesia</option>
                        <option value="wna" {{ $pendaftar->kewarganegaraan == 'wna' ? 'selected' : '' }}>Warga Negara
                          Asing
                        </option>
                      </select>
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Nama Kelurahan atau Desa"
                        id="kelurahan_desa" value="{{ $pendaftar->kelurahan_desa }}" name="kelurahan_desa">
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukan Nomor RW" id="rw"
                    ...
                    <div class="col-md-3 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukan Nomor Kode Pos" id="kode_pos"
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="tel" class="form-control" placeholder="+(62) xxxx xxxx xxx" id="no_hp"
                        value="{{ $pendaftar->no_hp }}" name="no_hp">

                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      <label for="telepon_rumah" class="form-label">Nomor Telepon Rumah</label>
                      <input type="tel" class="form-control" placeholder="+(62) xxxx xxxx xxx" id="telepon_rumah"
                        value="{{ $pendaftar->telepon_rumah }}" name="telepon_rumah">

                    </div>
                    <!--end col-->
                    <div class="col-md-4 mb-3">
                      <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                      <input type="text" class="form-control" placeholder="Masukkan Tempat Lahir" id="tempat_lahir"
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input type="date" class="form-control" placeholder="Masukkan Tanggal Lahir"
                        id="tanggal_lahir" value="{{ $pendaftar->tanggal_lahir }}" name="tanggal_lahir">
                  ...
                  <div class="d-flex align-items-start gap-3 mt-3">
                    <button type="button" class="btn btn-primary btn-label right ms-auto nexttab"
                      data-nexttab="pills-bio-orangtua-tab"><i
                        class="ri-briefcase-line label-icon align-middle fs-16 ms-2"></i>Lanjut ke Biodata Orang
                      Tua</button>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan NIK Ayah" id="nik_ayah"
                        value="{{ $pendaftar->wali->nik_ayah }}" name="nik_ayah">
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      <label for="status_ayah" class="form-label">Status Ayah</label>
                      <select id="status_ayah" class="form-select" data-choices data-choices-sorting="true"
                        name="status_ayah">
                        <option selected>Pilih Status...</option>
                        <option value="hidup" {{ $pendaftar->wali->status_ayah == 'hidup' ? 'selected' : '' }}>Hidup
                        </option>
                        <option value="wafat" {{ $pendaftar->wali->status_ayah == 'wafat' ? 'selected' : '' }}>Wafat
                        </option>
                      </select>
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Nama Ayah" id="nama_ayah"
                        value="{{ $pendaftar->wali->nama_ayah }}" name="nama_ayah">
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan NIK Ibu" id="nik_ibu"
                        value="{{ $pendaftar->wali->nik_ibu }}" name="nik_ibu">
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      <label for="status_ibu" class="form-label">Status Ibu</label>
                      <select id="status_ibu" class="form-select" data-choices data-choices-sorting="true"
                        name="status_ibu">
                        <option selected>Pilih Status...</option>
                        <option value="hidup" {{ $pendaftar->wali->status_ibu == 'hidup' ? 'selected' : '' }}>Hidup
                        </option>
                        <option value="wafat" {{ $pendaftar->wali->status_ibu == 'wafat' ? 'selected' : '' }}>Wafat
                        </option>
                      </select>
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Nama Ibu" id="nama_ibu"
                        value="{{ $pendaftar->wali->nama_ibu }}" name="nama_ibu">
                    </div>
                    <!--end col-->
                    <div class="col-md-6 mb-3">
                  ...
                  <div class="d-flex align-items-start gap-3 mt-4">
                    ...
                    <button type="button" class="btn btn-primary btn-label right ms-auto nexttab"
                      data-nexttab="pills-atribut-tab"><i
                        class="ri-shirt-line label-icon align-middle fs-16 ms-2"></i>Lanjut ke Atribut</button>
                  </div>
                </div>
              </div>
              <!-- end tab pane -->
                  ...
                  <div class="row">
                    @foreach ($list_berkas as $berkas)
                        <div class="col-lg-12 mb-3">
                            <label for="{{ 'file-' . $berkas->nama_berkas }}"
                                class="d-flex justify-content-between align-items-center">
                                Upload Berkas {{ Str::upper($berkas->nama_berkas) }}
                                <a class="btn btn-sm btn-primary" 
                                   href="{{ asset('file_pendamping/' . $berkas->path) }}" 
                                   download>Download Berkas</a>
                            </label>
                
                            <label for="{{ 'file-' . $berkas->nama_berkas }}" class="drop-container">
                                <i class="display-4 text-muted ri-upload-cloud-2-fill"></i>
                                <h4 class="drop-title">Drop files here or click to upload.</h4>
                                <input type="file" 
                                       name="{{ 'file[' . $berkas->nama_berkas . ']' }}" 
                                       id="{{ 'file-' . $berkas->nama_berkas }}" 
