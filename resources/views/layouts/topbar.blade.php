      ...
      <div class="d-flex align-items-center">
        ...
        {{-- <div class="dropdown topbar-head-dropdown ms-1 header-item">
          <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
            ...
            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-info">7<span
                ...
                <div data-simplebar style="max-height: 300px;" class="pe-2">
                  ...
                  <div class="text-reset notification-item d-block dropdown-item position-relative">
                    <div class="d-flex">
                      ...
                      <div class="flex-1">
                        <a href="#!" class="stretched-link">
                          <h6 class="mt-0 mb-2 fs-13 lh-base">You have received <b class="text-success">20</b> new
        ...
        <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <span class="d-flex align-items-center">
              ...
              <span class="text-start ms-xl-2">
                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">
                  {{ Auth::user()->role_id == 1 ? 'Administrator' : (Auth::user()->pendaftar->isNotEmpty() ? Auth::user()->pendaftar[0]->nama : 'No Name') }}
              </span>
          ...
          <div class="dropdown-menu dropdown-menu-end">
            ...
            {{-- <h6 class="dropdown-header">Welcome
              {{ Auth::user()->role_id == 1 ? 'Administrator' : Auth::user()->pendaftar[0]->nama }}</h6> --}}
              <h6 class="dropdown-header">Welcome
                {{ Auth::user()->role_id == 1 ? 'Administrator' : (Auth::user()->pendaftar->isNotEmpty() ? Auth::user()->pendaftar[0]->nama : 'No Name') }}
              </h6>
