                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                  <thead class="table-light">
                    <tr>
                      ...
                      <th data-sort="status_pendaftaran" class="text-center">PEMBAYARAN PENDAFTARAN</th>
                      <th data-sort="pembayaran_ukt" class="text-center">PEMBAYARAN UKT</th>
                    </tr>
                  </thead>
                  <tbody class="list form-check-all" id="tbodyPendaftarID">
                    ...
                    <tr>
                      ...
                      <td class="pembayaran_ukt text-center">
                          <span class="badge text-uppercase {{ optional($row->detailPendaftar)->status_pembayaran == 'sudah' ? 'badge-soft-success' : 'badge-soft-danger' }}">
                              {{ optional($row->detailPendaftar)->status_pembayaran ?? 'belum' }}
                          </span>
                      </td>
                  </tr>
...
@section('script')
  ...
  <script>
    var pendaftarList,
      perPage = 5,
      options = {
        valueNames: ["nik", "nama", "gelombang", "prodi", "status_pendaftaran", "pembayaran_ukt"],
        page: perPage,
        pagination: !0,
